...
Como executar o programa, quando houver código: Compile o código com um compilador C (GCC):
gcc main.c -o semaforo
Execute o programa:
./semaforo O semáforo será exibido no terminal em funcionamento contínuo.
...
#include <unistd.h>
int main() { while (1) { printf(" VERDE - Siga\n"); sleep(5);
Plain Text
